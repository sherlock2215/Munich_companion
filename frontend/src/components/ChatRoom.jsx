    ...
    return (
        <div style={{height: '100%', display: 'flex', flexDirection: 'column', color: '#1e293b'}}>
            <div style={{padding: '15px', borderBottom: '1px solid #e2e8f0', display: 'flex', alignItems: 'center', gap: '10px', background: 'white'}}>
                ...
                <div><h3 style={{margin:0, fontSize: '16px', color: '#0f172a'}}>{title}</h3><small style={{color: '#64748b'}}>Chat</small></div>
            </div>
            ...
            <div style={{padding: '15px', background: 'white', borderTop: '1px solid #e2e8f0', display: 'flex', gap: '10px'}}>
                <input value={input} onChange={e => setInput(e.target.value)} onKeyDown={e => e.key === 'Enter' && sendMessage()} placeholder="Write a message..." style={{flex: 1, padding: '12px', borderRadius: '24px', border: '1px solid #cbd5e1', background: '#f1f5f9', color: '#0f172a', outline: 'none'}} />
